...
def calculate_hash_sha256(plaintext):
...
def brute_force_attack(ciphertext, original_hash, key_length):
    ...
    for key in possible_keys:
        ...
        decrypted_hash =  calculate_hash_sha256(decrypted_text)
...
def run_test_cases():
    ...
    for i, (plaintext, key) in enumerate(test_cases):
        ...
        original_hash =  calculate_hash_sha256(original_plaintext)
